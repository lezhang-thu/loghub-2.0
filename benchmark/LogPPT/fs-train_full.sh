...
for dataset in Apache Hadoop HealthApp HPC Linux Mac OpenSSH OpenStack Proxifier Zookeeper; do
	shot=32
	trf="datasets-fs-full-wo-vl/${dataset}/${shot}shot/4.json"
	python x_train.py --train_file ${trf} \
		...
		--task_output_dir "result_LogPPT-fs_full" \
