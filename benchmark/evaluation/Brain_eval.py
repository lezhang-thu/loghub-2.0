...
sys.path.append('../')
sys.path.append(os.path.join('..', 'logparser-Brain'))

from benchmark import benchmark_settings
from x_Brain import LogParser
    ...
    for dataset in datasets:
        ...
        if os.path.exists(
                os.path.join(output_dir,
                             f"{dataset}_{data_type}.log_structured.csv")):
            parser = None
